...
@WebServlet(
		...
		initParams = { 
				@WebInitParam(name = "user", value = "sarita"), 
				@WebInitParam(name = "password", value = "123456bcd")
		})
public class LoginServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		if(getServletContext().getInitParameter("dbURL").equals("jdbc:mysql://localhost/JDBC") &&
